...
class MSICreator {
    constructor(options) {
        ...
        this.upgradeCode = options.upgradeCode || (0, uuid_1.v4)();
    ...
    createWxs() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const replacements = {
                ...
                '{{ApplicationShortcutGuid}}': (0, uuid_1.v4)(),
                ...
                '{{DesktopShortcutGuid}}': (0, uuid_1.v4)(),
    ...
    getRegistryComponent(registry, indent) {
        const guid = (0, uuid_1.v4)();
        const permissionXml = registry.permission ? (0, replace_1.replaceInString)(this.permissionTemplate, {
